...
informar quantas cédulas de cada valor serão entregues. OBS: considere que o caixa
possui cédulas de R$50, R$20, R$10 e R$1.'''

print('=' * 30)
print('{:^30}'.format('BANCO TD'))
print('=' * 30)
...
while True:
    if total >= céd:
        ...
        if total == 0:
            break
print('=' * 30)
print('Volte semore ao BANCO TD! Tenha um bom dia!')